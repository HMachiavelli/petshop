...
import com.henrique.petshop.domain.enums.SituacaoPagamento;
...
public class Pagamento implements Serializable {
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, situacao, valor);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(id, other.id) && situacao == other.situacao && Objects.equals(valor, other.valor);
	}
